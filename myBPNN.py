...
class BPNN(object):
    def __init__(self, input_n, hidden_n, output_n, lambd):
        ...
        self.Train_Label = tf.placeholder(tf.float64, shape=(None), name='input_labels')  # 训练数据集标签
    ...
    def train_test(self, Train_Data, Train_Label, Test_Data, Test_Label, learn_rate, epoch):
        """
        这是BP神经网络的训练函数
