...
# t_t = [[54918], [24], [450]]
#我的数据
# p_s = [[0.5872, 19.4865, 187.2141], [0.5207, 19.6553, 186.8363], [0.4614, 19.8187, 186.4589], [0.4309, 19.9812, 186.0718], [0.3577, 20.1435, 186.6734], [0.3339, 20.3054, 185.2632], [0.3232, 20.4671, 184.8396], [0.3208, 20.6285, 184.4034], [0.2962, 20.7896, 183.9543],
#        [0.2729, 20.9504, 183.4919], [0.2881, 20.1109, 183.0153]]  # 用来训练的数据集 x
# t_s = [[0.0022], [0.0026], [0.0030], [0.0032], [0.0040], [0.0043], [0.0045], [0.0047], [0.0052], [0.0057], [0.0055]]  # 用来训练的数据集x对应的实际结果 y
#
# p_t = [[0.3841, 19.5652, 207.5601], [0.3563, 20.2218, 207.4327], [0.2258, 21.0283, 207.2802]]  # 用来测试的数据集 x_test
# t_t = [[0.0013], [0.0014],
